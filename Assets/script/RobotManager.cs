...
public class RobotManager : MonoBehaviour
{
    ...
    public void ShowRobot() //mostra a vidoe il robot, metodo inserito nell'OnClick del pulsante di help
    {
        ...
        {
            fullText = "Questa è la tua aria personale. Qui potrai visualizzare le tue informazioni quali username e punteggio. Inoltre potrai vedere nella tabella i 7 " +
